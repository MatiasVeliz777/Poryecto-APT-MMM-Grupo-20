...
<div class="solicitud-container-wrapper" style="margin-top: -80px;">
    <div class="container">
        ...
        <p style="text-align: center; margin: 0 50px;">
            Este es el apartado de Felicitaciones, aquí podrás ver todos los colaboradores de la empresa a los cuales se les felicita, 
            y ver sus razones por cumplir con su grata función laboral.
        </p>
        ...
        <div class="row" style="margin-top: 20px;">
            ...
            if ($result_empleados_mes): 
                ...
                <?php endif; ?>
            <?php else: ?>
                <p class="text-center"><b>No se han registrado empleados del mes aún.</b></p>
            <?php endif; ?>
        </div>
    </div>
</div>
