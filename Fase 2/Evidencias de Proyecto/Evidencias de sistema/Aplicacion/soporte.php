...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        $mensaje = "💻¡Soporte Recibido!💻 Has recibido una solicitud de soporte tecnico, ve al portal y revisa donde y quien es para mitigarlo!";
        $query = "
        ...
        if ($stmt) {
            ...
            $stmt->bind_param("ss", $mensaje, $mensaje);    
...
<div class="solicitud-container-wrapper">
    ...
    <div class="solicitud-instructions">
        ...
        <p>2. (Opcional) Describe el problema con la mayor cantidad de detalles posible. <strong> Procura aclarar el Edificio y Piso en el cual se necesita el soporte.</strong></p>
        <p>4. Indica el Edificio donde se presenta la solicitud de soporte tecnico.</p>
    ...
    <div class="solicitud-container">
        ...
        <h5>Area: <?php echo $cargo_data['NOMBRE_CARGO'];?></h5>
            ...
            <div class="input-group">
                ...
                <textarea name="contenido" placeholder="Describe tu problema"></textarea>
            </div>
