...
if (!empty($eventos_ids)) {
    ...
    $asistencias_sql = "
        SELECT capacitacion_id, COUNT(*) AS total_asistentes
        FROM asistencia_capacitaciones
        WHERE capacitacion_id IN ($ids_placeholder)
    ...
    while ($row = $result_asistencias->fetch_assoc()) {
        $eventos_data[$row['capacitacion_id']]['asistentes'] = $row['total_asistentes'];
    }
}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    obtenerAlertas();
        ...
        <h1>Dashboard de Asistencia a Capacitaciones</h1>
    </header>
    ...
    <div class="container mt-0">
     ...
     <div class="text-center mb-4">
        <h2>Dashboard de Asistencia a Capacitaciones</h2>
    </div>
    ...
    options: {
        ...
        scales: {
            ...
            x: {
                title: {
                    display: true,
                    text: `Capacitaciones del mes de ${nombreMes}`
                }
            }
        },
        plugins: {
            title: {
                display: true,
                text: 'Estadísticas de Asistencia a Capacitaciones'
            }
        }
    }
});
