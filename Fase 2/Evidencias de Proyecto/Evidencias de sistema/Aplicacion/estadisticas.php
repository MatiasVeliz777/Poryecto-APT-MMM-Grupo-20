...
<div class="solicitud-instructions">
    <h3>Instrucciones para Visualizar Estadísticas</h3>
    <p>1. En este portal de <strong>Estadísticas</strong>, selecciona el gráfico o sección de estadísticas que deseas explorar.</p>
    <p>2. Si la opción está disponible, utiliza los filtros ubicados en la parte superior del dashboard:</p>
    <ul>
        <li><strong>Mes:</strong> Elige un mes específico o selecciona la opción <strong>“Todos”</strong> para visualizar estadísticas anuales.</li>
        <li><strong>Año:</strong> Selecciona el año para el que deseas ver las estadísticas.</li>
    </ul>
    <p>3. Presiona el botón <strong>“Filtrar”</strong> para actualizar los datos del gráfico según los filtros seleccionados.</p>
    <p>4. Haz clic en el botón <strong>“Descargar Gráfico como PDF”</strong> si deseas guardar las estadísticas en un archivo PDF para compartir o consultar posteriormente.</p>
    <p>5. Si no se seleccionan filtros, el dashboard mostrará las estadísticas más recientes disponibles.</p>
</div>
...
<div class="solicitud-container">
    ...
    <div class="d-flex flex-column align-items-center" STYLE="BACKGROUND-COLOR: WHITE;">
        ...
        <div class="dashboard-card d-flex align-items-center mb-3" style="width: 100%; max-width: 500px; background-color: #f8f9fa; padding: 10px; border-radius: 5px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div>
                <h5>Estadísticas de Foro</h5>
                <p style="font-size: 13px; color: #6c757d;">Consulta estadísticas sobre la participación en el foro, incluyendo preguntas y respuestas de los usuarios.</p>
        ...
        <div class="dashboard-card d-flex align-items-center mb-3" style="width: 100%; max-width: 500px; background-color: #f8f9fa; padding: 10px; border-radius: 5px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div>
                <h5>Estadísticas de Soporte</h5>
                <p style="font-size: 13px; color: #6c757d;">Visualiza estadísticas sobre las solicitudes de soporte técnico filtradas por edificio y nivel de urgencia.</p>
        ...
        <div class="dashboard-card d-flex align-items-center mb-3" style="width: 100%; max-width: 500px; background-color: #f8f9fa; padding: 10px; border-radius: 5px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div>
                <h5>Estadísticas de capacitaciones</h5>
                <p style="font-size: 13px; color: #6c757d;">Revisa estadísticas relacionadas con la asistencia a eventos y el comportamiento de los empleados en actividades grupales.</p>
