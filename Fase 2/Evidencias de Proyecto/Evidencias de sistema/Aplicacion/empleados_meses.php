...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['actualizar_empleado'])) {
        ...
        if ($conn->query($sql_update) === TRUE) {
            ...
            $mensaje = 'El empleado del año ha sido actualizado correctamente.';
        } else {
            $tipo_mensaje = 'error';
            $mensaje = 'Hubo un error al actualizar el empleado del año.';
        }
    }
    ...
    if (isset($_POST['confirmar_eliminar_empleado'])) {
        ...
        if ($conn->query($sql_delete) === TRUE) {
            $tipo_mensaje = 'success';
            $mensaje = 'El empleado del año ha sido eliminado correctamente.';
        } else {
            $tipo_mensaje = 'error';
            $mensaje = 'Hubo un error al eliminar el empleado del año.';
        }
    }
}
...
<header class="solicitud-header">
    <h1>Historial Empleados del Año</h1>
</header>

<div class="solicitud-container-wrapper" style="margin-top: -80px;">
    <div class="container">
    <h2 style="width: 100%; text-align: center;">Empleado del Año</h2>
    <p style="text-align: center; margin: 0 50px 0 50px">Este es el apartado de empleado del año, aquí podrás ver todos los empleados de los años pasados de la empresa, 
                                                            y ver sus razones por cumplir con su grata funcion laboral!</p>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow position-relative">
                            ...
                            <div class="d-flex justify-content-center align-items-center position-relative" style="background-color: white;">
                                <h3 class="text-center" style="color: #008AC9; width:280px; margin: 0; flex-grow: 1;"><?php echo $anio; ?></h3>
                            ...
                            <h5 class="text-center" style="color: #008AC9; margin-top: 0px;">Año</h5>
